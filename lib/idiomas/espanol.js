...
const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO YO COMO CREADOR(A) DEL BOT LO PUEDE USAR!!\`\`\`` } //NUMERO DE BOT
...
const smsAdmin = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO ES PARA ADMINISTRADORES!!\`\`\`` } //ADMINS
const smsBotAdmin = () => { return `\`\`\`¡¡NECESITO SER ADMINISTRADOR PARA QUE PUEDAS USAR ESTE COMANDO!!\`\`\`` } //BOT CON ADMIN
...
//MENU LISTA
const smsTime = () => { return `𝐓𝐈𝐄𝐌𝐏𝐎 𝐀𝐂𝐓𝐔𝐀𝐋`}
const smsUptime = () => { return `𝐀𝐂𝐓𝐈𝐕𝐎`}
const smsVersion = () => { return `𝐕𝐄𝐑𝐒𝐈𝐎𝐍 ${global.vs}`}
const smsTotalUsers = () => { return `TOTAL USUARIOS`}
const smsMode = () => { return `𝐌𝐎𝐃𝐎`}
const smsModePublic = () => { return `PUBLICO`}
const smsModePrivate = () => { return `PRIVADO`}
const smsBanChats = () => { return `𝐂𝐇𝐀𝐓(𝐒) 𝐏𝐑𝐎𝐇𝐈𝐁𝐈𝐃𝐎(𝐒)`}
const smsBanUsers = () => { return `𝐔𝐒𝐔𝐀𝐑𝐈𝐎(𝐒) 𝐏𝐑𝐎𝐇𝐈𝐁𝐈𝐃𝐎(𝐒)`}
const smsPareja = () => { return `𝐏𝐀𝐑𝐄𝐉𝐀`}
const smsResultPareja = () => { return `SIN PAREJA`}
...
const smsLista1 = () => { return `⧎ INFORMACIÓN SOBRE AVERNUS ⧎`}
const smsLista2 = () => { return `𓆩 CREADOR 𓆪`}
const smsLista3 = () => { return `彡 DONAR 彡`}
const smsLista4 = () => { return `𖢻 VELOCIDAD 𖢻`}
const smsLista5 = () => { return `𖣐 INFORMACIÓN - MENU 𖣐`}
const smsLista6 = () => { return `𖤺 MENU COMPLETO 𖤺`}
const smsLista7 = () => { return `𖤶 INSTALACION - AVERNUS 𖤶`}
const smsLista8 = () => { return `𖥑 SUB - BOT 𖥑`}
const smsLista9 = () => { return `𖤹 TÉRMINOS - TEMAS LEGALES 𖤹`}
const smsLista10 = () => { return `𖥔 AVENTURA 𖥔`}
const smsLista11 = () => { return `𖥸 TOP GLOBAL 𖥸`}
const smsLista12 = () => { return `⪨ USUARIOS PREMIUM ⪩`}
const smsLista13 = () => { return `≪ USUARIO(A) PREMIUM ≫`}
const smsLista14 = () => { return `꥟ MISIONES DIARIAS ꥟`}
const smsLista15 = () => { return `░ MENU - RPG ░`}
const smsLista16 = () => { return `✠ TIENDA - SHOP ✠`}
const smsLista17 = () => { return `※ INVENTARIO ※`}
const smsLista18 = () => { return `∆ MULTIMEDIA ∆`}
const smsLista19 = () => { return `◧ DESCARGAS ◧`}
const smsLista20 = () => { return `🔍 BUSQUEDAS 🔍`}
const smsLista21 = () => { return `⌗ CONVERTIDOR ⌗`}
const smsLista22 = () => { return `۞ MODIFICADOR DE AUDIO ۞`}
const smsLista22_1 = () => { return `🜲 HERRAMIENTAS 🜲`}
const smsLista23 = () => { return `⨷ DIVERSIÓN ⨷`}
const smsLista24 = () => { return `ッ JUEGOS DINÁMICOS ッ`}
const smsLista25 = () => { return `𖥳 AUDIOS 𖥳`}
const smsLista26 = () => { return `𖥡 STICKERS Y FILTROS 𖥡`}
const smsLista27 = () => { return `𖦲 EFECTOS Y LOGOS 𖦲`}
const smsLista28 = () => { return `𖧨 LOGOS VERSION 2 𖧨`}
const smsLista29 = () => { return `⨀ MEMES RANDOMS : ANIME ⨀`}
const smsLista30 = () => { return `≈ COMANDOS +18 ≈`}
const smsLista31 = () => { return `⊄ AJUSTES ⊅`}
const smsLista32 = () => { return `『GRUPOS』`}
const smsLista33 = () => { return `𖠰 LISTAS DISPONIBLES 𖠰`}
const smsLista34 = () => { return `◮ CENTRO DE CONFIGURACIÓN ◭`}
const smsLista35 = () => { return `« PROPIETARIO(A) »`}

//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨ BIENVENIDO(A)!!*\n┊💖 @user\n┊📄 *LEA LA DESCRIPCIÓN DEL GRUPO*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *SE FUE DEL GRUPO ¡CHAU!* ✿\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSdemote = () => { return '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊!!*'}
...
//_allantilink.js
const smsTextoYT = () => { return '👻 𝗠𝗬𝗟𝗜𝗡𝗚𝗕𝗢𝗧-𝗠𝗗 👻'} 
const smsApagar = () => { return '❌ DESACTIVADO'} 
const smsEncender = () => { return '✅ ACTIVO'} 
const smsEnlaceTik = () => { return `𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙏𝙄𝙆𝙏𝙊𝙆 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}
const smsEnlaceYt = () => { return `𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙔𝙊𝙐𝙏𝙐𝘽𝙀 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}
...
const smsEnlaceWc = () => { return `𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙐𝙉 𝘾𝘼𝙉𝘼𝙇 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}
const smsAllAdmin = () => { return `𝘿𝙀𝘽𝙊 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍 𝙋𝘼𝙍𝘼 𝙋𝙊𝘿𝙀𝙍 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍 𝘼 𝙄𝙉𝙏𝙍𝙐𝙎𝙊𝙎(𝘼𝙎)`}
const smsSoloOwner = () => { return `𝙀𝙇/𝙇𝘼 𝙋𝙍𝙊𝙋𝙄𝙀𝙏𝘼𝙍𝙄𝙊(𝘼) 𝘿𝙀𝘽𝙀 𝘼𝘾𝙏𝙄𝙑𝘼𝙍 𝙀𝙎𝙏𝘼 𝙁𝙐𝙉𝘾𝙄𝙊𝙉\n*#on restrict*`}

//handler.js
const smsCont1 = () => { return `*彡 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 𝗙𝗔𝗟𝗟𝗔𝗡𝗗𝗢 彡*`}
...
const smsCont6 = () => { return `*❗ 𝗣𝗥𝗢𝗕𝗟𝗘𝗠𝗔 𝗗𝗘𝗧𝗘𝗖𝗧𝗔𝗗𝗢*`}
const smsCont7 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*NO TIENE DIAMANTES!! 💎 PUEDE IR A LA TIENDA CON EL COMANDO*`}
const smsCont8 = () => { return ` *👻 MYLINGCOINS USADO(S)*`}
const smsCont9 = () => { return `${global.lenguajeMY['smsAvisoAG']()}*NECESITA EL NIVEL ➡️*`}
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeMY['smsAvisoEG']()}𝘾𝙊𝙈𝙊 𝙀𝙍𝙀𝙎 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙉𝙊 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼)`}
const smsEnlaceWat = () => { return `${lenguajeMY['smsAvisoAG']()}𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeMY['smsAvisoAG']()}𝙎𝙀 𝘿𝙀𝙏𝙀𝘾𝙏𝙊 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝙋𝙍𝙊𝙃𝙄𝘽𝙄𝘿𝙊 𝙌𝙐𝙀 𝘾𝙊𝙉𝙏𝙄𝙀𝙉𝙀 𝙃𝙏𝙏𝙋𝙎 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n𝙋𝙍𝙊𝘾𝙀𝘿𝙊 𝘼 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝙍𝙏𝙀`}

//_antispam.js
const smsNoSpam = () => { return `🤨 NO HAGAS SPAM, NO PODRÁ USAR A MYLINGBOT-MD POR ${60000 / 1000 - 59} MINUTO`}

//_antispam_.js
const smsNoSpam2 = () => { return `FUE DESBANEADO DESPUÉS DE ${60000 / 1000 - 59} MINUTOS. POR FAVOR NO HAGA SPAM!!`}

//Texto
const smsConMenu = () => { return `☘️ 𝗠 𝗘 𝗡 𝗨`} //🟡 NO CAMBIAR 

//Error
const smsMalError = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`OCURRIÓ UN ERROR INESPERADO.\`\`\``}
const smsMalError2 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`SURGIÓ UN INCONVENIENTE. INTENTE DE NUEVO.\`\`\``}
const smsMalError3 = () => { return `${lenguajeMY['smsAvisoFG']()}\`\`\`ALGO SALIÓ MAL, REPORTE ESTE COMANDO USANDO:\`\`\`\n`}
...
const smsToxic7 = () => { return `𝙎𝙐𝙋𝙀𝙍𝘼𝙎𝙏𝙀 𝙇𝘼𝙎 𝙏𝙊𝘿𝘼𝙎 𝙇𝘼𝙎 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼𝙎 𝘼𝙃𝙊𝙍𝘼 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼) 🙄`}

//Tienda
const eExp = () => { return '⚡ Experiencia' } 
const eDiamante = () => { return '💎 Diamantes' } 
const eDiamantePlus = () => { return '💎+ Diamantes' }
...
const eMylingCoins = () => { return '💵 MylingCoins' }
const eMylingTickets = () => { return '🎫 MylingTickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar MylingBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar MylingBot en Grupos`}
...
const smsConfi3 = () => { return `*SELECCIONE UNA OPCION DE LA LISTA*`}
const smsConfi4 = () => { return `*PARA EMPEZAR A CONFIGURAR*`}
const smsConfi5 = () => { return `● *AVISOS DE CONFIGURACION:*`}
const smsConfi6 = () => { return `✅ » *FUNCION ACTIVADA*`}
const smsConfi7 = () => { return `❌ » *FUNCION DESACTIVADA*`}
...
//_antiviewonce.js
const smsAntiView = () => { return `*𝙏𝙀 𝙀𝙎𝙏𝙊𝙔 𝙑𝙄𝙂𝙄𝙇𝘼𝙉𝙊 𝘽𝙍𝙊* 🤨📸`} 

//_autolevelup.js
const smsAutoLv1 = () => { return `👻 NUEVO NIVEL 👻`} 
...
const smsAutoLv6 = () => { return `HAS CONSEGUIDO OTRO NIVEL!!`} 
const smsAutoLv7 = () => { return `🌟 RECOMPENSA POR SU NUEVO NIVEL`} 

//_autosticker.js
const smsAutoStik = () => { return `${lenguajeMY['smsAvisoFG']()}🤨 EL VÍDEO NO DEBE DE DURAR MÁS DE 7 SEGUNDOS.*`} 

//_expired.js
const smsBottem1 = () => { return `*ME VOY DEL GRUPO!!! 🤝 SI QUIERE QUE VUELVA, USE EL COMANDO #BOTTEMPORAL PARA QUE VUELVA AL GRUPO!!*`} 
const smsBottem2 = () => { return `*💕 ASISTENCIA PARA USUARIOS*\n*_${global.asistencia}_*\n`} 
const smsBottem3 = () => { return `HASTA PRONTO 👻`} 

//_premium.js
const smsPremI = () => { return `*¡TU TIEMPO PREMIUM SE ACABO! ✨*\n*PARA OBTENER UN NUEVO PASE PREMIUM USE EL COMANDO:*\n*#PASE PREMIUM*`} 

//afk-_afk.js
const smsAfkM1 = () => { return `*DEJASTE DE ESTAR INACTIVO(A) AFK*`} 
const smsAfkM2 = () => { return `\n*EL 
MOTIVO DE INACTIVIDAD ERA:*\n`} 
const smsAfkM3 = () => { return `❕ *TIEMPO INACTIVO:*`} 
const smsAfkM4 = () => { return `*¡OYE! NO ETIQUETES A ESTE(A) USUARIO(A)!! ESTÁ INACTIVO(A)*\n`} 
const smsAfkM5 = () => { return `*MOTIVO DE LA INACTIVIDAD AFK:*\n`} 
const smsAfkM6 = () => { return `*MOTIVO DE LA INACTIVIDAD AFK:\nNO ESPECIFICÓ EL MOTIVO DE INACTIVIDAD*`} 
const smsAfkTime = () => { return [['día(s)'], ['hora(s)'], ['minuto(s)'], ['segundo(s)']] }
const smsAfkResultTime = smsAfkTime()

//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeMY['smsAvisoMG']()}*¿POR QUÉ CARAJO TE VAS A AUSENTAR?. ESCRIBA EL MOTIVO POR EL CUÁL ESTARÁ INACTIVO (AFK)*\n\n*EJEMPLO:*\n*${usedPrefix + command}* Voy a realizar tarea`} 
const smsAfkQ2 = () => { return `${lenguajeMY['smsAvisoMG']()}*¿POR QUÉ CARAJO DICES?. MÍNIMO 10 CARACTERES DEBE DE SER EL MOTIVO*`} 
const smsAfkM1A = () => { return `*NO ETIQUETEN A*`} 
const smsAfkM1B = () => { return `*ESTARÁ INACTIVO(A) AFK*\n\n*MOTIVO DE LA INACTIVIDAD AFK:*`} 

//anonymous_chat.js
const smsChatAn1 = () => { return `${lenguajeMY['smsAvisoFG']()}*NO ESTÁS EN CHAT ANÓNIMO*`} 
...
const smsChatAn4 = () => { return `${lenguajeMY['smsAvisoRG']()}🪐 *USTED SE FUE DEL CHAT ANÓNIMO*`} 
const smsChatAn5 = () => { return `${lenguajeMY['smsAvisoAG']()}*EL OTRO USUARIO SALIÓ DEL CHAT ANÓNIMO*`}  
const smsChatAn6 = () => { return `*SI QUIERES IR A OTRO CHAT ANÓNIMO USA EL COMANDO #start O USAR EL BOTÓN DE ABAJO*\n`} 
const smsChatAn7 = () => { return `${lenguajeMY['smsAvisoAG']()}*TODAVÍA ESTÁS EN UN CHAT ANÓNIMO O EN ESPERA A QUE ALGUIEN SE UNA PARA CHATEAR*`} 
...
const smsChatAn10 = () => { return `${lenguajeMY['smsAvisoEG']()}✨ *YA PUEDEN CHATEAR*`} 
const smsChatAn11 = () => { return `*ALGUIEN SE HA UNIDO AL CHAT ANÓNIMO!!*`} 
const smsChatAn12 = () => { return `❇️ OTRO(A) USUARIO(A)`} 
const smsChatAn13 = () => { return `${lenguajeMY['smsAvisoRG']()}😐 *ESPERANDO A QUE ALGUIEN SE UNA AL CHAT ANÓNIMO, TENGA PACIENCIA POR FAVOR*`} 
...
const smsLisB = () => { return '*✦ TOTAL GRUPOS:*'}
const smsLisC = () => { return '*✦ GRUPO:*'}
const smsLisD = () => { return '*✦ ID:*'}
const smsLisE = () => { return '*✦ PARTICIPANTES:*'}
const smsLisF = () => { return '*✦ ADMINISTRADOR:*'}
const smsLisG = () => { return '*✦ ENLACE:*'}

//ad
const smsMalused = () => { return '⚡ *USAR EL COMANDO DE ESTA FORMA:*\n'}
const smsMalused2 = () => { return `${lenguajeMY['smsAvisoMG']()}👻 *DEBE DE USAR EL COMANDO COMO EN ESTE EJEMPLO:*\n`}
const smsMalused3 = () => { return `${lenguajeMY['smsAvisoMG']()}👻 *DEBE DE USAR EL COMANDO O RESPONDER AL MENSAJE DE ALGUIEN COMO EN ESTE EJEMPLO:*\n`}
...
const smsGrupoTime7 = () => { return '🔒 *EL GRUPO ESTA CERRADO, SOLO ADMINISTRADORES PUEDEN ENVIAR MENSAJES*'}
...
//grupo-add.js
const smsAddB1 = () => { return `${lenguajeMY['smsAvisoFG']()}*NO SE PUEDE AGREGAR EL NÚMERO, VERFIQUE QUE SEA CORRECTO, TAL VEZ SALIÓ RECIENTEMENTE O SU PRIVACIDAD ESTA CONFIGURADA.*`}
const smsAddB2 = () => { return `${lenguajeMY['smsAvisoFG']()}*NO SE PUEDE AGREGAR EL NÚMERO, VERFIQUE QUE SEA CORRECTO, O AGRÉGELO MANUALMENTE.*`}

//grupo-admins.js
const smsAddB3 = () => { return `*NOTIFICACIÓN PARA ADMINITRADORES*`}
const smsAddB4 = () => { return `*PRESENCIA DE ADMINISTRADORES*`}
const smsAddB5 = () => { return `*MENSAJE:*`}
const smsAddB6 = () => { return `Solicito a los Admins por favor.`}

//grupo-advertencia.js
const smsAdveu1 = () => { return `${lenguajeMY['smsAvisoAG']()}*SOLO PUEDE USAR SI ESTÁ ACTIVADA LA FUNCIÓN:*\n`}
const smsAdveu2 = () => { return 'Motivo'}
const smsAdveu3 = () => { return `${lenguajeMY['smsAvisoMG']()}*RECUERDE ESCRIBIR EL MOTIVO DE LA ADVERTENCIA*\n`}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeMY['smsAvisoAG']()}*¿PERO A QUIÉN ELIMINO?. ETIQUETE A LA PERSONA O RESPONDA AL MENSAJE DE LA PERSONA QUE QUIERE ELIMINAR*\n\n*EJEMPLO: `}
const smskick2 = () => { return `ELIMINADO(A) 🫵😼`}
const smskick3 = () => { return `NO PUEDO ELIMINAR AL CREADOR DEL GRUPO 🫵😆`}
const smskick4 = () => { return `NO SEAS PENDEJO(A), NO ESTÁ EN ESTE GRUPO 👻`}

//grupo-tagall.js
const smstagaa = () => { return `😼 𝗧𝗘 𝗜𝗡𝗩𝗢𝗖𝗢 𝗕𝗥𝗢 😼`}

//grupo-setbye.js
const smsSetB = () => { return `${lenguajeMY['smsAvisoEG']()}*LA DESPEDIDA DEL GRUPO HA SIDO CONFIGURADA*`}
const smsSetB2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_ESCRIBA EL MENSAJE DE DESPEDIDA_*\n*_OPCIONAL PUEDE USAR LO QUE ESTA CON "@" PARA AGREGAR MÁS INFORMACIÓN:_*\n\n*⚡ @user (Mención al usuario(a))*\n\n*RECUERDE QUE EL "@" ES OPCIONAL*`}

//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeMY['smsAvisoEG']()}*LA BIENVENIDA DEL GRUPO HA SIDO CONFIGURADA*`}
const smsSetW2 = () => { return `${lenguajeMY['smsAvisoIIG']()}🙌 *_ESCRIBA EL MENSAJE DE BIENVENIDA_*\n*_OPCIONAL PUEDE USAR LO QUE ESTA CON "@" PARA AGREGAR MÁS INFORMACIÓN:_*\n\n*⚡ @user (Mención al usuario(a))*\n*⚡ @subject (Nombre de grupo)*\n*⚡ @desc (Description de grupo)*\n\n*RECUERDE QUE LOS "@" SON OPCIONALES*`}

//grupo-setdesc.js
const smsDest = () => { return `${lenguajeMY['smsAvisoEG']()}*LA DESCRIPCIÓN DEL GRUPO HA SIDO CONFIGURADA*`}

//grupo-setname.js
const smsNam1 = () => { return `${lenguajeMY['smsAvisoEG']()}*EL NOMBRE DEL GRUPO HA SIDO CONFIGURADO*`}
const smsNam2 = () => { return `${lenguajeMY['smsAvisoMG']()}*🙌 ESCRIBA EL NUEVO NOMBRE DEL GRUPO*`}
const smsNam3 = () => { return `${lenguajeMY['smsAvisoFG']()}*EL NOMBRE DEL GRUPO NO DEBE DE TENER MÁS DE 25 CARACTERES*`}

//grupo-restaurarEnlace.js
const smsRestGp = () => { return `${lenguajeMY['smsAvisoEG']()}*EL ENLACE DEL GRUPO HA SIDO RESTABLECIDO*`}
...
//propietario(a).js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeMY['smsAvisoMG']()}*ETIQUETE A ALGUIEN O RESPONDA AL MENSAJE DEL USUARIO O ESCRIBA EL NÚMERO QUE QUIERE BANEAR DE LOS COMANDOS*\n\n*EJEMPLO:*\n*${usedPrefix + command} @${bot}*`}
const smsPropban2 = (bot) => { return `${lenguajeMY['smsAvisoFG']()}*@${bot} NO PUEDE SER BANEADO CON ESTE COMANDO* 😹`}
const smsPropban3 = (ownerNumber) => { return `${lenguajeMY.smsAvisoIIG()}😳 *NO PUEDO BANEAR AL OWNER @${ownerNumber} DE ${packname}*`}
const smsPropban4 = (number) => { return `${lenguajeMY.smsAvisoIIG()}*NO ES NECESARIO VOLVER A BANEAR A @${number} SI YA LO ESTÁ* 😊`}
const smsPropban5 = () => { return `${lenguajeMY['smsAvisoEG']()}𝙀𝙇/𝙇𝘼 𝙐𝙎𝙐𝘼𝙍𝙄𝙊(𝘼) 𝙁𝙐𝙀 𝘽𝘼𝙉𝙀𝘼𝘿𝙊(𝘼) 🙀\n𝙉𝙊 𝙋𝙊𝘿𝙍𝘼 𝙐𝙎𝘼𝙍 𝘼 ${gt}`}
const smsPropban6 = (number, usr) => { return `${lenguajeMY.smsAvisoAG()}*@${number} ESTAS BANEADO/A POR @${usr} NO PUEDES USAR LOS COMANDOS HASTA QUE ALGUIEN REVIERTA EL BANEO* 😿`}
const smsPropban7 = (usedPrefix, command, number) => { return `${lenguajeMY['smsAvisoFG']()}*SURGIÓ UN ERROR, PUEDE SER QUE EL USUARIO NO ESTE EN MI BASE DE DATOS INTENTE ESCRIBIR ${usedPrefix + command} ${number}*\n\`\`\`SI EL ERROR CONTINÚA REPORTE ESTE COMANDO\`\`\``}

//jadibot-serbot.js
const smsIniJadi = () => { return `*ミ★ 𝐌𝐲𝐥𝐢𝐧𝐠𝐁𝐨𝐭-𝐌𝐃 - 𝐒𝐮𝐛-𝐁𝐨𝐭 ミ★*\n\n*🌹 VERSION MYLINGBOT-MD » _${global.vs}_*\n*🌹 VERSION JADIBOT » _${global.vsJB}_*\n\n🌟 *_FUNCIÓN SER SUB-BOT_* 🌟\n\n*😼 CON OTRO DISPOSITIVO O PC ESCANEA ESTE CODIGO QR PARA CONVERTIBLE EN SUB-BOT*\n\n*𝟏 - 𝐃𝐈𝐑𝐈𝐆𝐀𝐒𝐄 𝐀 𝐋𝐎𝐒 𝐓𝐑𝐄𝐒 𝐏𝐔𝐍𝐓𝐈𝐓𝐎𝐒 *"︙"* 𝐄𝐍 𝐋𝐀 𝐄𝐒𝐐𝐔𝐈𝐍𝐀 𝐒𝐔𝐏𝐄𝐑𝐈𝐎𝐑 𝐃𝐄𝐑𝐄𝐂𝐇𝐀\n*2️⃣ Ir a la opción Dispositivos vinculados*\n*3️⃣ Escanee este codigo QR para iniciar sesión*\n\n⏳️ *¡Este código QR expira en 45 segundos!*`}
const smsIniJadi2 = () => { return `*ミ★ 𝐌𝐲𝐥𝐢𝐧𝐠𝐁𝐨𝐭-𝐌𝐃 - 𝐒𝐮𝐛-𝐁𝐨𝐭 ミ★*\n\n*🌹 VERSION MYLINGBOT-MD » _${global.vs}_*
...
const smsSoloOwnerJB = () => { return `${lenguajeMY['smsAvisoAG']()}*ESTE COMANDO ESTÁ DESACTIVADO POR MÍ PROPIETARIO(A)*`}
const smsJBPrincipal = () => { return `${lenguajeMY['smsAvisoAG']()}🌹 *PARA SER SUB BOT DIRÍJASE AL NÚMERO PRINCIPAL*\n*ღ INGRESE A SIGUIENTE ENLACE:*\n`}
const smsreenvia = () => { return `*✨ REENVIA EL COMANDO...*`}
const smsJBConexion = () => { return `${lenguajeMY['smsAvisoFG']()}🟡 *LA CONEXIÓN SE HA CERRADO DE MANERA INESPERADA, INTENTAREMOS RECONECTAR...*`}
const smsJBConexionClose = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *LA CONEXIÓN SE HA CERRADO, DEBERÁ DE CONECTARSE MANUALMENTE USANDO EL COMANDO #serbot Y REESCANEAR EL NUEVO CÓDIGO QR*`}
const smsJBConexionClose2 = () => { return `${lenguajeMY['smsAvisoFG']()}🔴 *LA CONEXIÓN SE HA CERRADO, TENDRAS QUE VOLVER A CONECTARSE USANDO:*\n#deletesesion (Para borrar los datos y poder volver a solita el QR o el code)`}
const smsJBConexionTrue = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *CONEXIÓN CON ÉXITO!!!*`}
const smsJBConexionTrue2 = () => { return `${lenguajeMY['smsAvisoEG']()}🟢 *CONEXIÓN CON ÉXITO!!! PUEDE CONECTARSE USANDO SU (ID) O USAR:*`}
const smsJBCargando = () => { return `${lenguajeMY['smsAvisoIIG']()}😼 *ESTÁ CONECTADO(A)!! POR FAVOR ESPERE SE ESTÁ CARGANDO LOS MENSAJES...*\n\n♻️ *OPCIONES DISPONIBLES:*\n*» #stop _(Detener la función Sub Bot)_*\n*» #eliminarsesion _(Borrar todo rastro de Sub Bot)_*\n*» #serbot _(Obtener nuevo código QR para ser Sub Bot)_*`}
const smsJBInfo1 = () => { return `💖 *ENLACE ÚTIL*`}
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: mylingsoporte@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}

//jadibot-deleteSesion.js
const smsJBDel = () => { return `${lenguajeMY['smsAvisoAG']()}*USE ESTE COMANDO AL BOT PRINCIPAL*`}
const smsJBAdios = () => { return `${lenguajeMY['smsAvisoEG']()}*TE VOY A EXTRAÑAR ${global.packname} CHAOO!! CSMRE 🥹*`}
const smsJBCerrarS = () => { return `${lenguajeMY['smsAvisoEG']()}*HA CERRADO SESIÓN Y BORRADO TODO RASTRO*`}
const smsJBErr = () => { return `*HA CERRADO SESIÓN COMO SUB BOT* ♻️`}

//comandos+18-adult.js
const smsContAdult = () => { return `${lenguajeMY['smsAvisoAG']()}*LOS COMANDOS 🔞 ESTÁN DESACTIVADOS, SI USTED ES MI CREADOR(A) USE #on modohorny*`}
