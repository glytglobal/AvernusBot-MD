...
// ARREGLADO Y ADAPTADO PARA AVERNUS-BOT-MD POR GL YT MX
...
description = official[0][0] == String(contact[0]) ? '𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙊𝙁𝙄𝘾𝙄𝘼𝙇 𝘿𝙀 𝘼𝙑𝙀𝙍𝙉𝙐𝙎-𝘽𝙊𝙏-𝙈𝘿' : official[1][0] == String(contact[0]) ? lenguajeMY.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeMY.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeMY.smsContacto4() : desc === '' ? lenguajeMY.smsContacto5() : desc
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeMY.smsContacto8(), mail === '' ? 'glyt.xp.contacto@gmail.com' : mail, lenguajeMY.smsContacto7(), md, yt, ig, fb, paypal, nna])
